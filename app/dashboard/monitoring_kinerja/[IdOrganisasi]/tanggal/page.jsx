...
import { dummyTanggal } from '@/data/dummyData';
        ...
        },
        {
            ...
            render: (_, record) => (
                <Space size="small">
                    ...
                    />
                    <Button
                        onClick={() => router.push(`/dashboard/monitoring_kinerja/${IdOrganisasi}/tanggal/${record._id}/bawahan`)}
                        // type='primary'
                        size="middle"
                ...
                <div className="flex flex-col">
                    <div className="flex items-center justify-between mb-12">
                        <Title className="mt-2" level={5}>
                            Tanggal Monitoring Kinerja
                        </Title>
                    </div>
                    <DataTable columns={Column} data={dummyTanggal} loading={loading} />
