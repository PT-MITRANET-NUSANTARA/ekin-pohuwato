...
export const dashBoardCard = [
  { title: "Visi", icon: BlockOutlined, key: "visi", permission: ["admin", "umpeg"] },
  { title: "Misi", icon: AlignLeftOutlined, key: "misi", permission: ["admin"] },
  { title: "Renstra", icon: UserAddOutlined, key: "renstra", permission: ["verifikasi", "admin"] },
  { title: "Tujuan", icon: FieldTimeOutlined, key: "tujuan", permission: ["admin", "umpeg"] },
  { title: "Program", icon: UserAddOutlined, key: "program", permission: ["verifikasi"] },
  { title: "Kegiatan", icon: AlignLeftOutlined, key: "kegiatan", permission: ["admin", "verifikasi"] },
  { title: "Sub Kegiatan", icon: FieldTimeOutlined, key: "sub_kegiatan", permission: ["umpeg"] },
  { title: "Periode RKT", icon: UserAddOutlined, key: "periode_rkt", permission: ["admin", "verifikasi"] },
  { title: "RKT", icon: BlockOutlined, key: "rkt", permission: ["umpeg", "verifikasi"] },
  { title: "SKP", icon: AlignLeftOutlined, key: "skp", permission: ["admin"] },
  { title: "Harian", icon: FieldTimeOutlined, key: "harian", permission: ["verifikasi", "umpeg"] },
  { title: "Monitoring Kinerja", icon: UserAddOutlined, key: "monitoring_kinerja", permission: ["admin", "verifikasi"] },
  { title: "Absen", icon: BlockOutlined, key: "absen", permission: ["admin", "umpeg"] },
  { title: "TPP", icon: AlignLeftOutlined, key: "tpp", permission: ["verifikasi"] },
  { title: "JPT", icon: FieldTimeOutlined, key: "jpt", permission: ["admin", "umpeg"] }
];
